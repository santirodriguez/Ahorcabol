...
const I18N = {
  "es-AR": {
    ...
    hint: "Pista (−1 vida)",
    giveUp: "Me rindo",
    footer: "Ahorcabol — porque 90 minutos de sufrimiento no eran suficientes.",
  ...
  "en-US": {
    ...
    hint: "Hint (−1 life)",
    giveUp: "Give up",
    footer: "Ahorcabol — because 90 minutes of suffering apparently were not enough.",
  ...
  ca: {
    ...
    hint: "Pista (−1 vida)",
    giveUp: "Em rendeixo",
    footer: "Ahorcabol — perquè 90 minuts de patiment, pel que sembla, no eren prou.",
    languageSwitcher: "Idioma",
    scoreboard: "Marcador",
