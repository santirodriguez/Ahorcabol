...
const I18N = {
  "es-AR": {
    ...
    hint: "Pista (−1 vida)",
    giveUp: "Me rindo",
    footer: "Ahorcabol — para cuando ni culpar al árbitro alcanza.",
  ...
  "en-US": {
    ...
    hint: "Hint (−1 life)",
    giveUp: "Give up",
    footer: "Ahorcabol — for when blaming the referee still isn't enough.",
  ...
  ca: {
    ...
    hint: "Pista (−1 vida)",
    giveUp: "Em rendeixo",
    footer: "Ahorcabol — per quan ni culpar l'àrbitre és prou.",
    languageSwitcher: "Idioma",
    scoreboard: "Marcador",
