...
window.AHORCABOL_TEAM_DATA = [
  ...
  },
  {
    ...
    equipos: [
      ...
      "Racing de Santander", "Rayo Vallecano", "Real Betis", "Real Madrid", "Real Sociedad",
  ...
  },
  {
    ...
    equipos: [
      ...
      "Red Bull New York", "San Diego FC", "San Jose Earthquakes", "Seattle Sounders FC",
  ...
  },
  {
    ...
    equipos: [
      ...
      "Borussia Mönchengladbach", "Eintracht Frankfurt", "Elversberg", "Freiburg", "Hamburg",
  ...
  },
  {
    ...
    equipos: [
      ...
      "Marseille", "Monaco", "Nice", "Paris FC", "Paris Saint-Germain", "Rennes", "Strasbourg",
      "Toulouse", "Troyes"
    ]
  },
  {
    pais: "Portugal",
    equipos: [
      "Académico de Viseu", "Alverca", "Arouca", "Benfica", "Braga", "Casa Pia", "Estoril",
      "Estrela da Amadora", "Famalicão", "Gil Vicente", "Marítimo", "Moreirense", "Nacional",
      "Porto", "Rio Ave", "Santa Clara", "Sporting CP", "Vitória de Guimarães"
    ]
  },
  {
    pais: "Brasil",
    equipos: [
      ...
      "Coritiba", "Cruzeiro", "Flamengo", "Fluminense", "Grêmio", "Internacional", "Mirassol",
      "Palmeiras", "Red Bull Bragantino", "Remo", "Santos", "São Paulo", "Vasco da Gama", "Vitória"
    ]
  }
];
